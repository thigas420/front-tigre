  ...
  return (
    <div id="sidebar" className="h-dvh w-96">
      ...
      <div id="principal" className="flex flex-col">
        ...
        <button className="relative flex h-14 w-full flex-row items-center justify-start border-solid cursor-pointer border-r-sky-500 bg-blue-100 px-3 transition-all hover:border-r-3">
